...
export const defaultComponents: LibraryComponent[] = [
  ...
  // Edge Connector (card-edge gold fingers)
  {
    name: 'Edge Connector 1x8',
    category: 'connector',
    designatorPrefix: 'J',
    footprintName: 'EDGE-1x8',
    pinCount: 8,
    defaultProperties: { type: 'Card Edge', pitch: '100mil', plating: 'gold' },
    bodyWidth: 800,
    bodyHeight: 120,
    pads: Array.from({ length: 8 }, (_, i) => ({
      name: String(i + 1),
  ...
  {
    name: 'Edge Connector 1x16',
    category: 'connector',
    designatorPrefix: 'J',
    footprintName: 'EDGE-1x16',
    pinCount: 16,
    defaultProperties: { type: 'Card Edge', pitch: '100mil', plating: 'gold' },
    bodyWidth: 1600,
    bodyHeight: 120,
  ...
  {
    name: 'Edge Connector 2x16',
    category: 'connector',
    designatorPrefix: 'J',
    footprintName: 'EDGE-2x16',
    pinCount: 32,
    defaultProperties: { type: 'Card Edge Dual', pitch: '100mil', plating: 'gold' },
    bodyWidth: 1600,
    bodyHeight: 200,
    pads: Array.from({ length: 16 }, (_, i) => ({
      name: `T${i + 1}`,
